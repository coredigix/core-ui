...
_moveListenerGen= (listener, selector)->
	(event)->
		# original event
		...
		return
_customEvents.move= ['move', _moveListenerGen]
_customEvents.movestart= ['movestart', _moveListenerGen]
_customEvents.moveend= ['moveend', _moveListenerGen]
